...
def save_image(
    ...
    ''' save image file and process image before ocr

    args: 
        PDF_FILE: open file pdf 
        page_index: page position in pdf file being processed
...
def extract_image(pdf_file_name: str, page_index: int) -> tuple:
...
def print_xlsx(
    ...
    args: 
        WORKSHEET: write sentences(HN, QN) to xlsx
...
def process_page(
    ...
    if images:
        ...
        save_image(img, image_save_path, have_image_preprocessing=True)
